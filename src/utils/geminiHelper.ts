...
- **🎭 EL MOTOR DE SÍNTESIS NARRATIVA («LA COCTELERA DEL MASTER»)**: Los eventos no nacen del vacío ni de tablas aleatorias inconexas. El buen Director de Juego cruza los ingredientes vivos de la partida para generar drama con causa y efecto:
  - *Ingrediente A (El PJ y sus rarezas)*: Sus pertenencias confiscadas (violín, tablas de Ogham, libro de mapas celestes), su silencio o su origen insular.
  - *Ingrediente B (La Facción y sus líderes)*: Si Valas Hune subió con el reporte de los objetos a la cubierta de oficiales, la consecuencia lógica inmediata es la reacción del capitán (Jarlaxle) o de los lugartenientes: una orden de traslado al camarote de oficiales, un interrogatorio con las tablillas sobre la mesa o una propuesta astuta.
  - *Ingrediente C (El Mundo y la Navegación)*: Las corrientes gélidas del Mar de las Espadas, la cercanía a Luskan, la superstición de la marinería drow o el avistamiento de naves costeras.
