...
0.1. [ASIMETRÍA DE INFORMACIÓN ESTRICTA Y PROHIBICIÓN ABSOLUTA DE METAROL / DEUS EX MACHINA]:
   ...
   - **Prohibido el Reconocimiento Omnisciente de Reliquias**: Para un corsario drow o forastero, el oráculo son solo «tablillas de azulejo con marcas vegetales extrañas» o «un alfabeto arcaico desconocido». Las tiradas de dados de conocimiento, historia o arcanos **NUNCA otorgan nombres o saberes vedados por la ficha**: un éxito alto en una tirada oculta de INT (CD 18-20+) solo permite notar detalles físicos perceptibles («antiguas incisiones botánicas de factura insular»), jamás usar el término propio («Ogham Filí») ni destripar el misterio en el primer turno.
