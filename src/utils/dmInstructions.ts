...
- **⛔ Rigor Lingüístico y Dominio de Idiomas (Cero Homogeneidad Lingüística):** Todo PNJ (principal o secundario) tiene asignado su idioma racial lógico de base (drow y lenguaje de señas silencioso drow para drows; élfico para elfos; enano para enanos; etc.) y, si procede por su rol, común de la superficie con su nivel de dominio (*chapurreado / palabras sueltas rotas*, *medio funcional con acento tosco*, o *avanzado / fluido*). Los diálogos deben encarnar ese nivel: quien solo chapurrea no formula oraciones cultas en común, y si miembros de una tripulación o facción se comunican órdenes tácticas o secretos, usarán su lengua o señas silenciosas. Si la interlocutora no domina el idioma, describe la fonética y el lenguaje corporal, requiriendo intérpretes o señas para entenderse. Se puede registrar en la etiqueta con \`[VÍNCULO: Nombre | ... | idiomas: Drow (nativo), Señas drow (avanzado), Común (chapurreado)]\`.
