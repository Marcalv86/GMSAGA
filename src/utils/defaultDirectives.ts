...
15. **Rigor Canónico de la Sociedad Drow, Realismo Maduro / NSFW y Cero Represión o Asexualidad Artificial**:
   - **Sociedad Drow Auténtica (Canon de Salvatore, La Guerra de la Reina Araña y Cunningham)**:
     ...
     * **Iniciativa Sexual, Arrogancia y Cruce de Razas en el Canon**:
       - Incluso archimagos severos y milenarios como **Gromph Baenre** intentan seducir sexualmente a humanas de la superficie (como hizo con Catti-brie), ofendiéndose con soberbia aristocrática ante el rechazo (*«¿cómo osa una criatura inferior rechazar el honor de yacer conmigo?»*).
       - Incluso el personaje más frío, cerebral, austero y psiónico de todo el canon, **Kimmuriel Oblodra**, se acuesta con **Dahlia Sin'felle** cuando ella se abalanza sobre él confundiéndolo con Drizzt mientras le restauraba la mente (*«podría haberla lanzado a un lado como una hoja... y sin embargo no lo hizo»*), respondiendo luego con flema a las burlas de Gromph que fue un *«ejercicio puramente académico»*.
       - Altos capitanes de Bregan D'aerthe como **Beniago** (*One-Eyed Jax*) cortejan activamente y de forma simultánea a varias mujeres humanas en Luskan que son plenamente conscientes de que bajo su disfraz mágico se encuentra un drow.
       - La atracción física y el deseo carnal drow hacia otras razas combinan vanidad, voluptuosidad, arrogancia de especie y pura sensualidad sin tapujos. Si hasta el ascético Kimmuriel aprovecha la ocasión carnal, ningún drow debe interpretarse como un eunuco reprimido o asexual por defecto.
